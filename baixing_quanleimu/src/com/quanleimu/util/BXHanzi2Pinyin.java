...
public class BXHanzi2Pinyin {  
    ...
    public static BXHanzi2Pinyin getInstance() {  
        synchronized(BXHanzi2Pinyin.class) {  
            if (sInstance != null) {  
                return sInstance;  
            }  
            ...
            for (int i = 0; i < locale.length; i++) {  
                if (locale[i].equals(Locale.CHINA)) {  
                    sInstance = new BXHanzi2Pinyin(true);  
                    return sInstance;  
                }  
            }  
            Log.w(TAG, "There is no Chinese collator, HanziToPinyin is disabled");  
            sInstance = new BXHanzi2Pinyin(false);  
            return sInstance;  
        }  
    }  
    ...
    public static String hanziToPinyin(String hanzi){  
        String s = "";  
         ArrayList<Token> tokens = BXHanzi2Pinyin.getInstance().get(hanzi);  
