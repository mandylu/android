...
public class TrackConfig {
	...
	public interface TrackMobile {
		enum PVKey implements TrackMobile {//每条记录可能的key
			...
			KEYWORD("keyword","关键字"),
			FILTERKEYWORD("filterKeyWord","筛选关键字"),
			OTHERFILTER("otherFilter","其他筛选条件"),
			ADID("adId","adId"),
...
//			TOTAL_ADSCOUNT("total_adsCount","总条数"),
		...
		enum Event implements TrackMobile {//event相关的value
			...
			SETTINGS_LOGIN_RESULT("Settings_Login_Result","Settings_Login_Result"),
			SETTINGS_LOGIN_BACK("Settings_Login_Back","Settings_Login_Back"),
