...
//                        startDialogAuth(mAuthActivity, new String[]{});
     ...
     */
    public void authorize( final WeiboAuthListener listener, WeiboParameters params) {
    ...
    private void authorize(
            int activityCode, final WeiboAuthListener listener, WeiboParameters params) {
        ...
        if (!bindSucced) {
            if(mWeibo!=null){
            	if(params != null){
            		mWeibo.startAuthDialog(mAuthActivity, mAuthDialogListener, params);
            	}else{
            		mWeibo.startAuthDialog(mAuthActivity, mAuthDialogListener);
            	}
            }
