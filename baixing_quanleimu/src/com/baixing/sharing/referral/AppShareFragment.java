...
public class AppShareFragment extends BaseFragment implements View.OnClickListener, ICallback, Observer {
    ...
    public View onInitializeView(LayoutInflater inflater, ViewGroup container,
        ...
        ((Button) referralmain.findViewById(R.id.btn_referral_bluetooth)).setOnClickListener(new BtnBluetoothOnClickListener());
			...
			//if (!new File(apkName).exists()) {
				...
				if (originPath != null) {
					try {
						...
						e.printStackTrace();
						Toast.makeText(context, "写SD卡失败", Toast.LENGTH_SHORT).show();
					}
				} else {
