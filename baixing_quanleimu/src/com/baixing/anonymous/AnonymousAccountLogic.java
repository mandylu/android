...
public class AnonymousAccountLogic extends BaseAnonymousLogic{
	static private String[][] anonymousStatus = {
		...
		{Status_UnRegistered, 			Status_Number_UnAvailable, 	Status_Registered, 		Action_SendSMS,		Status_CodeReceived},		
		{Status_UnRegistered, 			Status_Number_UnAvailable, 	Status_CodeReceived, 	Action_Verify,		Status_Verified},
		...
		{Status_Registered_UnVerified, 	Status_Number_UnAvailable, 	Status_Initialization, 	Action_SendSMS,		Status_CodeReceived},
		{Status_Registered_UnVerified, 	Status_Number_UnAvailable, 	Status_Loginned,	 	Action_SendSMS,		Status_CodeReceived},
		{Status_Registered_UnVerified, 	Status_Number_UnAvailable, 	Status_CodeReceived, 	Action_Verify,		Status_Verified},		
		...
		{Status_Registered_Verified, 	Status_Number_UnAvailable, 	Status_ForgetPwd, 		Action_SendSMS,		Status_CodeReceived},
		{Status_Registered_Verified, 	Status_Number_UnAvailable, 	Status_CodeReceived, 	Action_Custom},
		{Status_Registered_Verified, 	Status_Number_Available, 	Status_ForgetPwd, 		Action_SendSMS,		Status_CodeReceived},
		{Status_Registered_Verified, 	Status_Number_Available, 	Status_CodeReceived, 	Action_Custom},
		{Status_Registered_UnVerified, 	Status_Number_Available, 	Status_ForgetPwd, 		Action_AutoVerifiy,	Status_Verified},
		{Status_Registered_UnVerified, 	Status_Number_UnAvailable, 	Status_ForgetPwd, 		Action_SendSMS,		Status_CodeReceived},
		{Status_Registered_UnVerified, 	Status_Number_UnAvailable, 	Status_CodeReceived, 	Action_Verify,		Status_Verified},
