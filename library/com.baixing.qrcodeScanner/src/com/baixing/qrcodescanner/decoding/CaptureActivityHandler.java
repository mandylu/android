...
package com.baixing.qrcodescanner.decoding;
...
import com.baixing.qrcodescanner.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  public void handleMessage(Message message) {
    if (message.what == R.id.lib_qrcode_auto_focus) {
        ...
        state = State.PREVIEW;
		CameraManager.get().requestPreviewFrame(decodeThread.getHandler(), R.id.lib_qrcode_decode);
  ...
  public void quitSynchronously() {
    ...
    Message quit = Message.obtain(decodeThread.getHandler(), R.id.lib_qrcode_quit);
    quit.sendToTarget();
    try {
      decodeThread.join();
