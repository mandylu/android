...
//		Log.d("trackmobile","@"+event.getName());
	...
	{
		Log.d("trackmobile","@" + ("event".equals(log.getMap().get(Key.TRACKTYPE.getName()))?log.getMap().get(Key.EVENT.getName()):log.getMap().get(Key.URL.getName())) + ":\t" +log.toJsonObj().toString());
